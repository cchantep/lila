...
object Dependencies {
  ...
  val rmVer = "0.16.0"
  val RM = "org.reactivemongo" %% "reactivemongo" % rmVer
  val rmIteratees = "org.reactivemongo" %% "reactivemongo-iteratees" % rmVer
  val rmNative = "org.reactivemongo" % "reactivemongo-shaded-native" % s"${rmVer}-linux-x86-64"
